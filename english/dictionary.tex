...
\DeclareDocumentCommand{\fun}{m}{}
% \DeclareDocumentCommand{\fun}{}{}  % Switch to this for fun-mode

%FYLL I VID ÄNDRINGAR%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\updated}{2019-02-08} %Insert
...
\begin{description}
    ...
    \phrase{NC}{NC}[The building opposite Basen where many D-students study.]
    \phrase{Nördcentrum}{Nördcentrum}[\lit{The Nerd Center} \see{NC}]
    \phrase{Idéläran}{Idéläran}[\formal \see{NC}]
...
\begin{description}
    ...
    \phrase{Tentavecka}{Exam week}[\abbr{TV} A week during which exams are held. Located at the end of each study period. \fun{Abbreviated TV due to the procrastination that occurs during this week}]
    ...
    \fun{\phrase{Rekursion}{Recursion}[\see{Rekursion}]}
\end{description}
...
\begin{description}
    ...
    \phrase{Hobbykommitté}{Hobby committee}[An often smaller and slightly more focused committee under the division.]
    ...
    \phrase{Delta}{PR committee}[]
    \phrase{DRUST}{Armoury}[Takes care of the division's premises.]
    \phrase{DNollK}{Bachelors' reception committee}[]
    \phrase{DAG}{Career and business relations committee}[]
    \phrase{dHack}{System administrators}[]
    \phrase{Ståthållarämbetet}{Flag bearers}[]
    \phrase{iDrott}{Sports committee}[]
    \phrase{DLude}{Games committee}[]
    \phrase{D-Foto}{Photo committee}[]
    \phrase{DBus}{Division car maintainers}[]
    \phrase{D-lirium}{Division newspaper}[]
    \phrase{DMNollK}{Masters' reception committee}[]
