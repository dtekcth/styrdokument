...
\subsubsection{}
I samband med representationskläder kan även tygmärken köpas in till kommittéen. Inköpet av märken får max subventioneras till kostnaden av inköp av 25 märken per persin i kommittéen. Här tar styrelsen extra hänsyn till att priset inte är onödigt högt (jämfört med andra kommittéer)
...
\begin{itemize}
    ...
    \item Sektionsstyrelsen har rätt att köpa in en ny bil efter att ha fått en proposition till sektionsmötet gokdänd med en specifikation på kostnad och krav för bilen godkänd.
...
\begin{itemize}
  \item Sektionsstyrelsen har rätt att bevilja uttag ur fonden på belopp upp till totalt \prisbasbelopp{0.25} per tillfälle. Uttag av belopp överstigande \prisbasbelopp{0.25} skall godkännas av sektionsmöte innan medel utbetalas.
  \item Sektionsstyrelsen äger inte rätt att ta ut mer än 50\% av fondens totala värde per tillfälle.
  \item Sektionsmötet äger rätt att vid välmotiverat behov göra uttag över \prisbasbelopp{0.25} eller i strid med syftet i \S\ref{sec:idefond_syfte}.
\end{itemize}
\end{document}
