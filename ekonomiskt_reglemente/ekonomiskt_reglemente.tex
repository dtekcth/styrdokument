...
\newcommand{\updated}{2024-08-03} %Insert
...
\begin{itemize}
    \item[-] \prisbasbelopp{0.01} för teambuildingaktiviteter per person.
    ...
    \item[-] \prisbasbelopp{0.008125}  per post för aspning och aspplagg sammanlagt.
\end{itemize}
...
Kostnaden för representationskläder får inte överstiga 0.014 prisbasbelopp 
...
\subsubsection{}
Varje kommitée har rätt att skicka in en förfrågan för att använda upp
till 0.04 prisbasbelopp per person i kommitéen. För att få lov att köpa 
