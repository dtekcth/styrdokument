...
\begin{itemize}
  ...
  \item illsammans med intresseförenings kassör skriva ett bindande avtal med styret angående skuldfrågan vid felaktig bokföring.
\end{itemize}

\subsection{}\label{sec:intresseförening:kassör}
...
\begin{itemize}
  ...
  \item ägga budget enligt \ref{sec:intresseförening:budget}.

\end{itemize}

\subsection{}
För intresseföreningar som saknar kassör ansvarar istället sektionsstyrelsens kassör för samtliga av punkterna i \ref{sec:intresseförening:kassör} med undantag för att lägga budget vilket görs i samråd med intresseförenings ordförande

\subsection{Budget}\label{sec:intresseförening:budget}
Varje intresseförening ska i början av året lägga en budget för hur dess pengar ska spenderas. Det är upp till styrelsens kassör att delge en mall för budget för att underlätta kommittéernas arbete. I budgeten ska det tydligt framgå hur pengarna ska spenderas med en uppskattning för vilken månad utgifter och inkomster hamnar i.

subsubsection{}
Varje intresseförenings budgetförslag ska godkännas av styrelsen. Som rapporterar vidare relevant information till sektionsmötet
...
\subsubsection{Stödkapital}
Styret har rätt att utföra kortfristiga lån till intresseföreningar vid behov. Dessa
ska isåfall betalas tillbaka senast i slutet av mandatperioden
...
Medlem, kommitteér eller intresseföreningar som önskar extra ekonomiska medel till
sin verksamhet eller arrangemang skall inkomma med önskemål och skäl till styret.
Styret kan bevilja extra medel om beloppet faller inom ramarna för de olika fon-
derna som styrelsen förvaltar. Om äskningen inte fallar inom dessa ramar kan den
ändå beviljas förutsatt att beloppet understiger \prisbasbelopp{0.25} och inte överstiger
sektionens budget.
\subsection{Till sektionsmötet}
Medlem¸ kommittéer eller intresseföreningar kan också inkomma med önskemål om
extra ekonomiska medel till sin verksamhet eller arrangemang genom motion till
sektionsmötet. Finansieringen av motionen ska göras med prioritet på medel från de
fonder som styrelsen förvaltar.
