...
\subsubsection{}
Kommitté ska ha ordförande, samt ett i reglementet fastställt antal förtroendeposter.
\subsubsection{}
Kommitté ska verka för teknologsektionens bästa och ha en i reglemente fastställd uppgift.

\subsection{Val}
\subsubsection{}
Samtliga poster tillsätts av sektionsmöte om inte annat stadgats i reglementet. 
\subsubsection{}
Val till kommitté kan beredas av valberedning enligt \ref{sec:valberedning}.
\subsubsection{}
Valbar till ledamot i kommitté är medlem. Valbar till ordförande eller, i förekommande fall, kassör är den som är myndig. Utöver detta kan ytterligare krav för valbarhet stadgas i reglementet.
...
Teknologsektionens kommittéer är de i reglemente förtecknade.
\newpage
