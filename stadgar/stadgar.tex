...
\newcommand{\updated}{2018-09-25} %Insert
...
\subsection{Ändamål}
\subsubsection{}
Datateknologsektionen vid Chalmers, härmed benämnd teknologsektionen, är en ideell kommitté bestående av studerande vid utbildningsprogrammet för datateknik vid Chalmers.
\subsubsection{}
...
\subsubsection{}
Sammansättning: DNS består av ordförande, vice ordförande och upp till fyra övriga medlemmar. Samtliga väljs på sektionsmötet.
\subsubsection{}
...
\subsection{Ekonomi}
\subsubsection{}
Respektive ordförande och kassör i sektionskommitté tecknar var för sig kommitténs firma.
\subsubsection{}
...
\subsection{Definition}
\subsubsection{}
Kommittéen skall ha ordförande och består i övrigt av intresserade medlemmar.
\subsubsection{}
