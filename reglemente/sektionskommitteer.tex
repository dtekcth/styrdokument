...
\paragraph{Det åligger D6s ordförande att:}
\begin{itemize}
  \item representera sektionen på kårens gasqueforum 
\end{itemize}
...
\subsubsection{Ansvar}
\paragraph{Det åligger DNollKs ordförande att:}
\begin{itemize}
  \item representera sektionen på kårens mottagningsforum 
\end{itemize}
\subsubsection{Val}
Ordförande, kassör och 4--5 övriga medlemmar väljs av sektionsmötet. 
\subsubsection{Mandatperiod}
...
\subsubsection{Val}
Bilansvarig och Vice Bilansvarig väljs av Sektionsmötet. Personerna skall inneha giltigt B-körkort. Vid avsaknande av ordförande faller DBUS ansvar på styrelsen. Till kassör väljs automatiskt DRusts kassör.
\subsubsection{Mandatperiod}
Mandatperioden är densamma som verksamhetsåret.
