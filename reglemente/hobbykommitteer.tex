...
Kommittéers vars ordförande väljs internt skall rapportera in vald ordförande till styrelsen.
\subsection{DLirium}
\subsubsection{Uppdrag}
Skall roa och kritiskt granska sektionen, kåren och Chalmers. 
\subsubsection{Val}
Fyra redaktörer väljs av sektionsmötet. Chefredaktör, tillika ansvarig utgivare utses internt av de valda redaktörerna.
...
\subsubsection{Val}
Nya medlemmar väljs av komitténs medlemmar. Ordförande väljs internt.
\subsubsection{Mandatperiod}
